...
class HistoryHtmlTestCase(unittest.TestCase):
    def test_export_history_html_writes_expected_sections(self) -> None:
        ...
        app.maintenance_run_once(runs_limit=10, events_limit=10, runner_id="ops-runner")
        ...
        self.assertIn("Active Workspace", html)
        ...
        self.assertIn("workspace-nav", html)
        ...
        self.assertIn("Stalled Runners", html)
        self.assertIn("Maintenance Cycles", html)
        self.assertIn("Failed Maintenance", html)
        self.assertIn("Last Maintenance", html)
        self.assertIn("Maintenance Runners", html)
        self.assertIn("Stalled Maintenance Runners", html)
        self.assertIn("Broker Syncs", html)
        self.assertIn("Broker Sync Failed", html)
        self.assertIn("Broker Stale", html)
        ...
        self.assertIn("Recent Maintenance Cycles", html)
        self.assertIn("maintenance-runner-table", html)
        ...
        self.assertIn("Cycle Age", html)
        self.assertIn("Stall Threshold", html)
        self.assertIn("Stalled", html)
        self.assertIn("Last Success", html)
        self.assertIn("Latest Pending", html)
        ...
        self.assertIn("Broker Health", html)
        self.assertIn("Broker Reconcile", html)
